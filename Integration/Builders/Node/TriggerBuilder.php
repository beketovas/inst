...
class TriggerBuilder implements NodeBuilderContract
{
    protected $nodeModel;
    ...
    {
        $this->nodeModel->setAttribute('name', __('integration::node.trigger'));
    }
    ...
    public function setAvailableApplications()
    {
        ...
        $this->nodeModel->setAttribute('available_applications', $this->applicationRepository->getForTrigger($this->nodeModel->user->id));
    }
    ...
    public function setApplicationData()
    {
        ...
        if(empty($this->nodeModel->application)) {
            ...
            $applicationBuilder = ApplicationBuilders\FactoryTriggerBuilder::getInstance($this->nodeModel);
            $applicationBuilder->setNodes($this->nodes);
