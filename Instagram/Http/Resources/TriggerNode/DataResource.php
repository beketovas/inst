...
class DataResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $settingsCollection = $this->settings ? SettingsResource::collection($this->settings) : null;
        ...
        return [
            ...
            'settings' => $settingsCollection ? $settingsCollection->toArray($this->settings) : null,
